...
func (c *GraphQLClient) MutateWithContext(ctx context.Context, name string, m any, variables map[string]any) error {
...
func (c *GraphQLClient) Mutate(name string, m any, variables map[string]any) error {
...
// to the GitHub GraphQL schema.
func (c *GraphQLClient) QueryWithContext(ctx context.Context, name string, q any, variables map[string]any) error {
...
func (c *GraphQLClient) Query(name string, q any, variables map[string]any) error {
